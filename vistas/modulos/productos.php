  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <table id="tablaProductos" class="table table-bordered table-striped dt-responsive " width="100%">
                ...
                <div class="col-xs-6">
                  ...
                  <div class="col-xs-6" style="padding:0">
                    ...
                    <div class="input-group">
                      ...
                      <input id="porcentaje" type="number" name="porcentaje" class="form-control input-lg nuevoPorcentaje" min="0" value="40" required>
